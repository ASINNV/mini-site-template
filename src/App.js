    ...
    return (
      <div id="app-container" className="ta-center">
        ...
        <header className="hor-pad-20 bg-gray">
          <p className="sm-text text-gray vert-pad-10">full website coming soon!</p>
        </header>
                ...
                <div className="r-margin">
                  ...
                  <div id="contact" className="contact-container vert-margin">
                    ...
                    <div className="contact-info-group">
                      <a href="tel:+15555555555"><i id="phone-button" className="fa fa-phone-square fontawesome-contact" onMouseEnter={this.showContactInfo.bind(this)}/></a>
                    </div>

                    <div className="contact-info-group">
                      <a href="mailto:companyname@gmail.com"><i id="email-button" className="fa fa-envelope-square fontawesome-contact" onMouseEnter={this.showContactInfo.bind(this)}/></a>
                    </div>

                    <div className="contact-info-group">
                      <a href="https://www.google.com/maps/place/Point+Arena,+CA+95468/@38.9111833,-123.7104193,15z/data=!3m1!4b1!4m5!3m4!1s0x808118d7d648777d:0x755ce630f0324829!8m2!3d38.9088009!4d-123.6930943" rel="noopener noreferrer" target="_blank"><i id="address-button" className="fa fa-map-pin fontawesome-contact" onMouseEnter={this.showContactInfo.bind(this)}/></a>
                    </div>
                  ...
                  <div id="social" className="social-container vert-margin">
                    <div className="d-inline-block w-18">
        ...
        <footer className="bg-gray text-gray">
